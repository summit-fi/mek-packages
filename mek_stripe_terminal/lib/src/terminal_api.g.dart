...
class SetupAttemptCardPresentDetailsApi {
  SetupAttemptCardPresentDetailsApi({this.emvAuthData, this.generatedCard});
...
class LocationApi {
  LocationApi({this.address, this.displayName, this.id, this.livemode, this.metadata});
...
class PaymentIntentApi {
  ...
  static PaymentIntentApi decode(Object result) {
    ...
    return PaymentIntentApi(
      ...
      amountTip: result[11] as int?,
      statementDescriptor: result[12] as String?,
      statementDescriptorSuffix: result[13] as String?,
      amountCapturable: result[14] as int?,
      amountReceived: result[15] as int?,
      applicationId: result[16] as String?,
      applicationFeeAmount: result[17] as int?,
